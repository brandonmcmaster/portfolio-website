...
const AboutMe = () => {
  return (
    <div className="container mx-auto bg-cover bg-center text-white text-center p-5 sm:p-20" style={{ backgroundImage: `url('https://t4.ftcdn.net/jpg/04/20/77/27/240_F_420772734_EUQv6soEJ0dZ2bcug8frDt73Pk4yXUbb.jpg')`, backdropFilter: 'blur(4px)', backgroundColor: 'rgba(0, 0, 0, 0.7)' }}>
      <div className="rounded-lg p-5 sm:p-10 sm:border-2 border-gray-200" style={{ backdropFilter: 'blur(20px)' }}>
        <section className="text-center">
          ...
          <img src={VocalBooth} alt="Brandon McMaster" className="mx-auto mb-4 max-w-full sm:max-w-md" />
          ...
          <img src={Graduation} alt="Brandon's Tech Journey" className="mx-auto mb-4 max-w-full sm:max-w-md" />
